...
<body>
  <div class="wrapper">
    ...
    <div class="header" id="header">
      ...
      <!-- logo start -->
      <img src="<?php echo $site_logo; ?>" alt=""></a></h1>
      <!-- logo end -->
      ...
      <ul class="nav">
        ...
        <?php foreach( $nav_menus_obj as $obj ) { ?>
        <li>
          <a href=""  title="<?php echo $obj->title; ?>">
            <i class="<?php echo $obj->icon; ?>"></i>
            <?php echo $obj->text; ?>
          </a>
        </li>
  ...
  <script type="text/template" id="swipid">
...
<script type="text/template" id="panelNew">
<h3>最新发布</h3>
{{ each item }}
<div class="entry">
  <div class="head">
  ...
  <div class="main">
    ...
    <p class="extra">
      <span class="reading">阅读({{ $value.views ? $value.views : 0 }})</span>
      <span class="comment">评论({{ $value.count || 0 }})</span>
      <a href="javascript:;" class="like">
        <i class="fa fa-thumbs-up"></i>
        <span>赞({{ $value.likes ? $value.likes : 0 }})</span>
      </a>
      <a href="javascript:;" class="tags">
  ...
  <script>
    ...
    $.get( "./index_swipe.php", function( info ) {
        $( ".swipe" ).html( template( "swipid", {
          list : info
        } ) );
        swipe();
    } );
    $.get( "./index_panel.php", function( info ){
      console.log( info );
     $( ".panelnew" ).html( template( "panelNew", {
       item: info.result
     } ) );
    } );
    ...
    $( "#header ul.nav a" ).click( function() {
      ...
      location.href = "./list.php"+ "?"+"title="+this.title;
    } );
  </script>
</body>
</html>
